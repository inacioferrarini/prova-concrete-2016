...
class EntityHourlySyncRule: EntityBaseSyncRules {
    
    class func fetchEntityHourlySyncRuleByName(name: String, inManagedObjectContext context:NSManagedObjectContext) -> EntityHourlySyncRule? {
