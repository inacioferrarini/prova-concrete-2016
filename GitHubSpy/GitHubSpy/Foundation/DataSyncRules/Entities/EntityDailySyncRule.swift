...
class EntityDailySyncRule: EntityBaseSyncRules {

    class func fetchEntityDailySyncRuleByName(name: String, inManagedObjectContext context:NSManagedObjectContext) -> EntityDailySyncRule? {
    ...
    class func entityDailySyncRuleByName(name:String, days: NSNumber?, inManagedObjectContext context:NSManagedObjectContext) -> EntityDailySyncRule? {
        ...
        if entityDailySyncRule == nil {
            let newEntityDailySyncRule = NSEntityDescription.insertNewObjectForEntityForName(self.entityName(), inManagedObjectContext: context) as! EntityDailySyncRule
    ...
    override func shouldRunSyncRuleWithName(name:String, date:NSDate, inManagedObjectContext context:NSManagedObjectContext) -> Bool {
